---
description: Run a bounded market scan; emit claims and candidate opportunities.
---

# /wgf-scan

**Transition** `portfolio:market-scan`
**Role** `research`


Run a bounded market scan; emit claims and candidate opportunities.
...
4. Delegate the work to the `research` agent.
