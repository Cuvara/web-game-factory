---
description: Draft the title strategy including kill criteria, then take it to approval.
---

# /wgf-strategy

**Transition** `title: concept -> strategy -> design`
**Role** `game-designer`
**Gate** `G2` — see `core/lifecycle/gates.yaml` for its required artifacts, predicates and approvers.

Draft the title strategy including kill criteria, then take it to approval.
