---
name: qa
description: Test suites, device matrices, defect triage, and performance measurement. Supports the qa role(s). Use when working on that part of the Factory lifecycle.
---
