...
"prototype|gameplay|title: prototype -> prototype-review|-|Build the prototype to a fun-testable standard and write the prototype report."
"review|portfolio-owner|title: prototype-review -> production, prototype or abandoned|G4|The kill gate. Judge the prototype against the kill criteria set at strategy."
...
skills=(
"market-intelligence|research|Normalizing platform signal into tiered claims and keeping evidence honest.|core/lifecycle/stages/market-scan.md;core/artifacts/shared/claim.schema.json"
...
"game-design|game-designer|Core loop, session structure, retention hooks, scope tiers, and the design consistency rules.|core/lifecycle/stages/design.md;core/artifacts/game-design.schema.json;core/reference/design-consistency-rules.yaml"
"monetization|game-designer, sdk|Placement design against platform ad capabilities and cadence limits.|core/artifacts/game-design.schema.json;core/reference/platforms/"
"architecture|architect|Engine selection, performance budgets, and the generic/game/platform ownership split.|core/lifecycle/stages/tech-plan.md;core/artifacts/tech-plan.schema.json"
...
"pixijs|gameplay, ui|2D rendering with PixiJS: sprites, spritesheets, animation, particles.|core/artifacts/tech-plan.schema.json"
"threejs|gameplay|3D with Three.js: scene management, GLB/GLTF, Draco/Meshopt, KTX2 textures.|core/artifacts/tech-plan.schema.json"
"assets|asset|Asset manifests, sourcing, licensing, and compression pipelines.|core/artifacts/asset-manifest.schema.json"
...
"qa|qa|Test suites, device matrices, defect triage, and performance measurement.|core/lifecycle/stages/qa.md;core/artifacts/verification-report.schema.json;core/artifacts/qa-report.schema.json"
"release|release|Manifests, checksums, store metadata, platform assertions, and submission.|core/lifecycle/stages/release-candidate.md;core/lifecycle/stages/publish.md;core/artifacts/release-manifest.schema.json"
)
